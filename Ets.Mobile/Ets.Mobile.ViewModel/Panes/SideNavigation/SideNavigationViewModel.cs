...
namespace Ets.Mobile.ViewModel.Panes.SideNavigation
{
    public class SideNavigationPaneViewModel : ReactiveObject, ISideNavigationPaneViewModel
    {
        ...
        public Type[] GradeTypes { get; } = { typeof(SelectCourseForGradePageViewModel), typeof(GradePageViewModel) };
