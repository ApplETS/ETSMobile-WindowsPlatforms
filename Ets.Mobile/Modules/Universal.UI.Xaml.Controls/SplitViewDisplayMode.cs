...
namespace Universal.UI.Xaml.Controls
{
    ...
    public enum SplitViewDisplayMode
    {
        ...
        /// <summary>
        /// The amount of the pane defined by the <see cref="SplitView.CompactPaneLength"/> property is shown side-by-side with the content and takes up space in the control layout. 
        ...
        /// <summary>
        /// The amount of the pane defined by the <see cref="SplitView.CompactPaneLength"/> property is shown side-by-side with the content and takes up space in the control layout. 
        /// The remaining part of the pane pushes the content to the side when it's open and takes up space in the control layout.
        /// </summary>
        CompactInline = 3
    }
}
